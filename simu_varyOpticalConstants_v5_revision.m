...
dataFolder = ['\\utu.fi\taltio\MaterialEngineering\SEMS\ajkamp\SolarCellSimulation\Data\OpticsOfBiBasedPIMs\',...
    num2str(year(dateToday)),'_',num2str(month(dateToday)),'_',num2str(day(dateToday)),'_',activeMat,'_Revision'];
...
kScale = 0.5:0.05:1.5;
% kScale = 1;
% TODO: Sensitivity analysis of optical constants: include n sensitivity
